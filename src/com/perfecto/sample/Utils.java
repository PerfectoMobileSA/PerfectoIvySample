...
public class Utils extends Task {
	...
	public static String fetchCloudName(String cloudName) throws Exception {
		...
		if(finalCloudName == null || finalCloudName.equalsIgnoreCase("<<cloud name>>"))
			throw new Exception("Please replace <<cloud name>> with your perfecto cloud name (e.g. demo) or pass it as ant properties: -DcloudName=<<cloud name>>");
		else
	...
	public static String fetchSecurityToken(String securityToken) throws Exception {
		...
		if(finalSecurityToken == null || finalSecurityToken.equalsIgnoreCase("<<security token>>"))
			throw new Exception("Please replace <<security token>> with your perfecto security token or pass it as ant properties: -DsecurityToken=<<SECURITY TOKEN>>");
		else
